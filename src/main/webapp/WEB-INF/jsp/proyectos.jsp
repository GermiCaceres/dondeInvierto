...
<html lang="en">
	...
	<body>
		...
		<div class="container theme-showcase" role="main">
			...
			<!-- Tira error pero funciona, eclipse things -->
			<c:if test = "${!(dataBase.esVacio()) && msg == null}">
         		<div class="alert alert-info" role="alert">
					<strong>Tenga cuidado!</strong> Ya se ha detectado un proyecto cargado, si carga otro archivo este mismo sera reemplazado.
				</div>
			</c:if>
			<c:choose>
			    <c:when test="${msg == 1}">
			    ...
			    <c:when test="${msg == 2}">
			    	<div class="alert alert-danger" role="alert">
						<strong>Error!</strong> Operacion interrumpida, por favor vuelva a intentarlo.
					</div>
			    </c:when>
			    <c:when test="${msg == 3}">
			    	<div class="alert alert-danger" role="alert">
			    ...
			    <c:when test="${msg == 4}">
			    	<div class="alert alert-danger" role="alert">
						<strong>Error!</strong> No se ha elegido ningun archivo, por favor vuelva a intentarlo.
					</div>
			    </c:when>
			</c:choose>
			...
			<form method="post" action="generarProyecto.html" enctype="multipart/form-data">
				<div class="form-group">
					...
					<p class="help-block">Debe ser archivo de extension ".csv" </p>
				</div>
